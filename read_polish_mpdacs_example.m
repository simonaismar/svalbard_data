...
% raw data "mpdacs-180601-104750.log" --> "mpdacs_example_data.mat"
% important: import data with space delimeter not fixed width
% output: mpdacs_example_data_read & raw plots
% columns headers are:
% logDate             col# 1  
% logTime             col# 2  
...
% load data
load('mpdacs_example_data.mat')

% time
dd=table2array(mpdacs_example_data(:,1));
hhmm=table2array(mpdacs_example_data(:,2));
nanosec=table2array(mpdacs_example_data(:,3)); 
...
% parameters 
turbidity=table2array(mpdacs_example_data(:,4));
fluorescence=table2array(mpdacs_example_data(:,5));

arlocChl_time=table2array(mpdacs_example_data(:,6));
arlocChlA1=table2array(mpdacs_example_data(:,7));
arlocChlA2=table2array(mpdacs_example_data(:,8));
arlocDepth=table2array(mpdacs_example_data(:,9));
arlocTemperature=table2array(mpdacs_example_data(:,10));

arlocXIncl=table2array(mpdacs_example_data(:,11));         %col# 11
arlocYIncl=table2array(mpdacs_example_data(:,12));         %col# 12
arlocZAcc=table2array(mpdacs_example_data(:,13));          %col# 13
arlocGyro=table2array(mpdacs_example_data(:,14));          %col# 14
arlocBattery=table2array(mpdacs_example_data(:,15));       %col# 15

ctd305Conductivity=table2array(mpdacs_example_data(:,16));
ctd305Temperature=table2array(mpdacs_example_data(:,17));
ctd305Depth=table2array(mpdacs_example_data(:,18));
ctd305Salinity=table2array(mpdacs_example_data(:,19));
ctd305O2Percent=table2array(mpdacs_example_data(:,20)); % oxygen
ctd305O2Ppm=table2array(mpdacs_example_data(:,21)); % oxygen
ctd305pH=table2array(mpdacs_example_data(:,22));
ctd305Eh=table2array(mpdacs_example_data(:,23)); % redox

mkdir plots_mpdacs_example_data
cd plots_mpdacs_example_data
mkdir rawplots
cd rawplots
